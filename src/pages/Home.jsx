...
function Home() {
  ...
  return (
     ...
     <div className="mb-4 col-span-full xl:mb-2">
        ...
        {/* ---------------------------- content ----------------------------------- */}
        { posts.length === 0 ?  
          <div id="alert-additional-content-3" class="p-4  my-36 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
